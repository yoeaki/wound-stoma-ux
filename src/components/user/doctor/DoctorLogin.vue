<template>
    <div class="login-wrap">
        <div class="ms-login">
            ...
            <div class="ms-title" style="color:black;">医生登录</div>
            <el-form :model="param" :rules="rules" ref="login" label-width="0px" class="ms-content">
                ...
                <div>
                    <el-link type="primary" @click="studentLogin()">用户登录中心</el-link>
                </div>
            </el-form>
        </div>
    </div>
    ...
    methods: {
        ...
        submitForm() {
            ...
            this.$refs.login.validate(valid => {
                if (valid) {
                    axiso.post('api/doc/doctor/login',this.param).then(function (response) {
