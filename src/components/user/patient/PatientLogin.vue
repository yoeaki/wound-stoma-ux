<template>
    <div class="login-wrap">
        <div class="ms-login">
            ...
            <div class="ms-title" style="color:black;">用户登录</div>
            <el-form :model="param" :rules="rules" ref="login" label-width="0px" class="ms-content">
                ...
                <div>
                    <el-link type="primary" @click="coachLogin()">医生登录中心>></el-link>
                </div>
            </el-form>
        </div>
    </div>
    ...
    methods: {
        ...
        submitForm() {
            ...
            this.$refs.login.validate(valid => {
                if (valid) {
                    axiso.post('api/pat/patient/login',this.param).then(function (response) {
                        ...
                        if (data.status === 0) {
                            ...
                            _this.$router.push('/patientDashboard')
